...
![AI Formula Diagram](/assets/learn/ai-basics/ai-formula.png)
...
*   **GPUs (Graphics Processing Units):** Originally designed for video games, these chips are incredible at doing many math problems at the exact same time.
...
You have the fuel (Data) and the engine (Computers). Now, you need the design.
