...
<YouTubeEmbed id="aircAruvnKk" title="But what is a Neural Network? by 3Blue1Brown" />
...
![Diagram of a Neural Network architecture showing the flow of data from Input Layer to Hidden Layers and finally to the Output Layer](/images/learn/ai-basics/module-1-7.png)
