...
![Illustration of Weak AI represented by a robot specialized in playing chess but unable to perform other tasks](/images/learn/ai-basics/weak-ai-chess.png)
...
![Concept art of Strong AI, depicting a robot capable of performing various human-like tasks and reasoning](/images/learn/ai-basics/strong-ai-versatile.png)
...
![Futuristic illustration of Super Intelligence, representing an AI with cognitive abilities far surpassing human minds](/images/learn/ai-basics/super-ai-brain.png)
...
<MCQ
  question="Which type of AI do we currently have in the real world?"
  options={["Artificial General Intelligence (AGI)", "Artificial Narrow Intelligence (ANI)", "Artificial Super Intelligence (ASI)", "All of the above"]}
  correct="Artificial Narrow Intelligence (ANI)"
  explanation="We only have Narrow AI today. AGI and ASI are still theoretical concepts."
/>
